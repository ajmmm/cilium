...
func getLRPs(txn statedb.ReadTxn, lrps statedb.Table[*LocalRedirectPolicy], frontends statedb.Table[*lb.Frontend], backends statedb.Table[*lb.Backend], pods statedb.Table[daemonk8s.LocalPod]) []*models.LRPSpec {
...
func (lrp *LocalRedirectPolicy) getModel(txn statedb.ReadTxn, frontends statedb.Table[*lb.Frontend], backends statedb.Table[*lb.Backend], pods statedb.Table[daemonk8s.LocalPod]) *models.LRPSpec {
	if lrp == nil {
		return nil
	}
...
func getPodIDByIP(txn statedb.ReadTxn, pods statedb.Table[daemonk8s.LocalPod]) map[string]string {
