...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *FrontendParams) DeepEqual(other *FrontendParams) bool {
	if other == nil {
		return false
	}
	...
	if in.PortName != other.PortName {
		return false
	}
	if in.ServicePort != other.ServicePort {
		return false
	}
...
func (in *Service) deepEqual(other *Service) bool {
	...
	if in.NatPolicy != other.NatPolicy {
		return false
	}
	...
	if in.SessionAffinityTimeout != other.SessionAffinityTimeout {
		return false
	}
	...
	if in.LoopbackHostPort != other.LoopbackHostPort {
		return false
	}
	if ((in.PortNames != nil) && (other.PortNames != nil)) || ((in.PortNames == nil) != (other.PortNames == nil)) {
		in, other := &in.PortNames, &other.PortNames
